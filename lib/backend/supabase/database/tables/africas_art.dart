...
class AfricasArtTable extends SupabaseTable<AfricasArtRow> {
  @override
  String get tableName => 'africasArt';

  @override
  AfricasArtRow createRow(Map<String, dynamic> data) => AfricasArtRow(data);
}

class AfricasArtRow extends SupabaseDataRow {
  AfricasArtRow(super.data);

  @override
  SupabaseTable get table => AfricasArtTable();
