...
class WildlifeTable extends SupabaseTable<WildlifeRow> {
  @override
  String get tableName => 'Wildlife';

  @override
  WildlifeRow createRow(Map<String, dynamic> data) => WildlifeRow(data);
}

class WildlifeRow extends SupabaseDataRow {
  WildlifeRow(super.data);

  @override
  SupabaseTable get table => WildlifeTable();
