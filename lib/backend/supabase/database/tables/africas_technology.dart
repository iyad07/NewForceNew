...
class AfricasTechnologyTable extends SupabaseTable<AfricasTechnologyRow> {
  @override
  String get tableName => 'africasTechnology';

  @override
  AfricasTechnologyRow createRow(Map<String, dynamic> data) =>
      AfricasTechnologyRow(data);
}

class AfricasTechnologyRow extends SupabaseDataRow {
  AfricasTechnologyRow(super.data);

  @override
  SupabaseTable get table => AfricasTechnologyTable();
