...
class AfricanTourismTable extends SupabaseTable<AfricanTourismRow> {
  @override
  String get tableName => 'africanTourism';

  @override
  AfricanTourismRow createRow(Map<String, dynamic> data) =>
      AfricanTourismRow(data);
}

class AfricanTourismRow extends SupabaseDataRow {
  AfricanTourismRow(super.data);

  @override
  SupabaseTable get table => AfricanTourismTable();
