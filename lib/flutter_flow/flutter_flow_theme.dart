...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFDA6F00);
  late Color secondary = const Color(0xFF000000);
  late Color tertiary = const Color(0xFF00F792);
  late Color alternate = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF000000);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF805000);
  late Color accent2 = const Color(0xFF975505);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondaryText = const Color(0xFFC0BBBB);
  late Color primaryBackground = const Color(0xFF000000);
  late Color secondaryBackground = const Color(0xFF121212);
  late Color accent1 = const Color(0xFF805000);
  late Color accent2 = const Color(0xFF975505);
  late Color accent3 = const Color(0x4D000000);
  late Color accent4 = const Color(0xFF2A2727);
