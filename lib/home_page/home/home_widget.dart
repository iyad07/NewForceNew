                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Read Articles About the New Force',
                          style:
                  ...
                  SingleChildScrollView(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        FutureBuilder<List<NewForceArticlesRow>>(
                          future: NewForceArticlesTable().queryRows(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<NewForceArticlesRow>
                                rowNewForceArticlesRowList = snapshot.data!;
                            ...
                            return SingleChildScrollView(
                              ...
                              child: Row(
                                ...
                                children: List.generate(
                                    rowNewForceArticlesRowList.length,
                                    (rowIndex) {
                                  final rowNewForceArticlesRow =
                                      rowNewForceArticlesRowList[rowIndex];
                                  return Padding(
                                    padding:
                                        const EdgeInsetsDirectional.fromSTEB(
                                            8.0, 8.0, 16.0, 8.0),
                                        ...
                                        context.pushNamed(
                                          ...
                                          queryParameters: {
                                            'publisher': serializeParam(
                                              rowNewForceArticlesRow.publishers,
                                              ParamType.String,
                                            ),
                                            'articleImage': serializeParam(
                                              rowNewForceArticlesRow
                                                  .articeImage,
                                              ParamType.String,
                                            ),
                                            ...
                                            'title': serializeParam(
                                              rowNewForceArticlesRow.title,
                                              ParamType.String,
                                            ),
                                            'datecreated': serializeParam(
                                              rowNewForceArticlesRow.createdAt,
                                              ParamType.DateTime,
                                            ),
                                            'newsUrl': serializeParam(
                                              rowNewForceArticlesRow.urlLink,
                                              ParamType.String,
                                            ),
                                          }.withoutNulls,
                                        );
