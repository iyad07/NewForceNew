...
class _SidebarWidgetState extends State<SidebarWidget> {
  ...
  void initState() {
    ...
    _model.isAuthenticated = currentUser != null;
    
    // Verify authentication status after build is complete
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // Double check authentication status and update model
      setState(() {
        _model.isAuthenticated = currentUser != null;
      });
    });
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        child: Padding(
          padding: const EdgeInsetsDirectional.fromSTEB(16.0, 16.0, 16.0, 46.0),
          child: Column(
                  ...
                  child: Column(
                    ...
                    children: [
                      if (_model.isAuthenticated)
                        // Show Log Out option for authenticated users
                        Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 0.0, 12.0),
                          child: InkWell(
